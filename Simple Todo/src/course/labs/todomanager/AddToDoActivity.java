...
public class AddToDoActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		submitButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Priority priority = getPriority(mPriorityRadioGroup);


				// TODO - Get the current Status
				Status status = getStatus(mStatusRadioGroup);

				// TODO - Get the current ToDoItem Title
				String titleString = mTitleText.getText().toString();
                Log.i("i am here", titleString);

				// Construct the Date string
				String fullDate = dateString + " " + timeString;
                Log.i("date string " , fullDate);
    ...
    private Priority getPriority(RadioGroup priority)
    {
        if (priority.getCheckedRadioButtonId() == R.id.lowPriority)
        {
            return Priority.LOW;
        }
        else if (priority.getCheckedRadioButtonId() == R.id.highPriority)
        {
    ...
    private Status getStatus(RadioGroup status)
    {
        if (status.getCheckedRadioButtonId() == R.id.statusDone)
            return Status.DONE;
        else
